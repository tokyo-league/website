...
const sections = [
  ...
  },
  {
    ...
    callouts: [
      "① Owner、Editor、問い合わせ先（受信専用）を追加します。同じメールアドレスで保存すると既存担当者を更新できます。",
      "② Editorに担当リーグを割り当てます。",
      "③ 割当一覧です。「解除」で担当リーグを外します。",
      "④ 登録済み担当者です。表示名・ロールを編集できます。",
      "⑤ Owner、Editor、問い合わせ先の権限概要です。",
    ],
    steps: [
      "「担当者を追加」でメールアドレス、表示名、ロールを入力し「担当者を保存」を押します。",
    ...
    notes: [
      ...
      "問い合わせ先（受信専用）: 公開フォームから送信された問い合わせメールを受信します。管理画面にはログインできません。",
      ...
      "問い合わせ先を無効化すると、そのメールアドレスへの問い合わせ配信が停止します。",
  ...
  },
  {
    ...
    callouts: [
      "① 登録済み担当者の編集エリアです。",
      "② 表示名、メール、ロール、有効状態を確認します。問い合わせ先は受信先として表示されます。",
      "③ 「担当者を更新」で変更を保存します。",
      "④ 退任者は無効化できます。削除可能なEditor・問い合わせ先は削除できます。",
    ],
    steps: [
    ...
    notes: [
      ...
      "Owner / Editorを無効化すると管理画面へログインできません。問い合わせ先を無効化すると問い合わせメールが届かなくなります。",
      "ログイン中Ownerの自己降格、最後のOwnerのEditor変更はできません。",
...
<body>
  ...
  <section class="page limit-page">
    ...
    <table>
      <tbody>
        <tr><th>年度・大会・リーグ</th><td>新規追加、編集、削除、現在年度切替、公開状態、表示順、期間、公開日の管理に対応済みです。関連データがある場合は削除できません。</td></tr>
        ...
        <tr><th>更新履歴</th><td>Owner専用画面でニュース、大会、試合、資料などの直近作成・更新履歴を確認できます。削除済みデータの独立した監査ログは追加実装候補です。</td></tr>
        <tr><th>固定ページ・問い合わせ本文設定・会場</th><td>問い合わせ受信先は担当割当画面で管理できます。固定ページ本文、問い合わせページ本文、会場マスタの管理UIはなく、追加実装候補です。</td></tr>
