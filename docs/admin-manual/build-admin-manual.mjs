...
const sections = [
  ...
  },
  {
    ...
    notes: [
      ...
      "管理画面にログインさせない問い合わせ専用の担当者は、管理画面権限で「ログインなし」を選び、問い合わせ受信を有効にします。",
  ...
  },
  {
    ...
    callouts: [
      ...
      "③ 「担当者を更新」で変更を保存します。",
      "④ 退任者は無効化できます。削除可能なEditor・ログインなし担当者は削除できます。",
    ],
    steps: [
  ...
  },
  {
    ...
    steps: [
      ...
      "OwnerまたはEditorにも受信設定を追加できます。管理画面にログインさせない受信専用の担当者は、管理画面権限で「ログインなし」を選びます。",
    ...
    notes: [
      ...
      "「ログインなし」は管理画面へログインできません。問い合わせ専用として使う場合は、問い合わせ受信も有効にしてください。",
...
const globalChecklist = [
  ...
  ["権限・問い合わせ", "Owner / Editor / ログインなし、問い合わせ受信の重複設定、担当者編集・無効化、担当リーグ割当、割当解除、担当者削除制限、問い合わせ受信先管理"],
  ...
  <section class="page limit-page">
    ...
    <table>
      <tbody>
        ...
        <tr><th>問い合わせ受信先</th><td>公開サイトの問い合わせフォームは、有効かつ「問い合わせ先としてメールを受信する」が有効な担当者のメールアドレスへ配信します。Owner / Editorと重複して設定でき、受信だけを止める場合はチェックを外して更新します。管理画面にログインさせない受信専用担当者には「ログインなし」を設定します。</td></tr>
