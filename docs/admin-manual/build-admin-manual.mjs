...
<body>
  <section class="page cover">
    ...
    <p>ログイン、権限、担当割当、問い合わせ受信先、試合結果、お知らせ、チーム、資料、トップページ、理事会、大会管理の運用手順をまとめた管理者向け手順書です。</p>
    <div class="meta">
  ...
  <section class="page limit-page">
    ...
    <table>
      <tbody>
        ...
        <tr><th>固定ページ・問い合わせ本文設定・会場</th><td>トップページの3つのメッセージは管理画面で編集できます。問い合わせ受信先は担当割当画面で管理できます。その他の固定ページ本文、問い合わせページ本文、会場マスタの管理UIはなく、追加実装候補です。</td></tr>
