...
const sections = [
  ...
  {
    title: "15. 資料管理: 新規・更新・削除・公開URL確認",
    image: "downloads.png",
    markers: [
      ["①", 46, 28],
      ["②", 47, 53],
...
const globalChecklist = [
  ...
  ["試合", "対象リーグ選択、結果画像追加・差替、星取表画像生成・結果画像登録、試合追加・更新・削除"],
