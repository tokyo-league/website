...
const pages = [
  ...
  { slug: "results-import-guide", path: "/admin/results/import", label: "結果管理 入稿進行状況", heading: "入稿の進行状況" },
  { slug: "results-excel", path: "/admin/results/import", label: "結果管理 Excel入稿", heading: "Excelで試合結果を入稿" },
