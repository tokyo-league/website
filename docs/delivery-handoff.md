...
| 納品前証跡 | コマンド結果と本番確認結果 | `docs/output/delivery-evidence-*.md` | `npm run delivery:evidence -- --final --production-url https://<production-domain> --env-file .env.production.local --include-build --include-e2e` |
