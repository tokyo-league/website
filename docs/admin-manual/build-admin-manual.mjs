...
const sections = [
  ...
  },
  {
    ...
    notes: [
      ...
      "順位表行の追加と入力クリアは追加実装候補です。",
    ],
  },
  {
    title: "9. お知らせ管理: 一覧・新規作成・更新・削除",
    image: "news-list.png",
    markers: [
      ["①", 84, 25],
      ["②", 80, 43],
...
const globalChecklist = [
  ...
  ["順位表", "まとめて保存、試合結果から再計算、登録内容確認、個別行削除"],
  ...
  <section class="page limit-page">
    ...
    <table>
      <tbody>
        ...
        <tr><th>順位表行</th><td>登録済み順位表はまとめて保存で上書きできます。個別行削除は対応済みです。行追加・入力クリアは追加実装候補とします。</td></tr>
